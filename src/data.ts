...
export const courses: Course[] = [
  {
    ...
    price: 4999,
    originalPrice: 9999,
    desc: 'SQL, Excel, and Power BI to analyse data and present decisions. Python is not in this live course yet.',
    longDesc: 'A hands-on Data Analytics course designed to take you from spreadsheets to dashboards. You work with published datasets, build Power BI reports, and practice presenting insights. Python and Generative AI units belong to the programme brochure, not this live course.',
    outcomes: ['Analyse business datasets with SQL', 'Build interactive Power BI dashboards', 'Create Excel models and pivot tables', 'Present data insights to stakeholders', 'Complete the published Sales Analysis and HR Dashboard projects'],
  ...
  },
  {
    ...
    outcomes: ['Write Python programs from scratch', 'Manipulate data with pandas', 'Visualise data with matplotlib and seaborn', 'Complete the published data project'],
  ...
  },
  {
    ...
    outcomes: ['Write effective prompts for production use cases', 'Build RAG systems with LangChain', 'Ship the published LLM application project', 'Understand LLM architectures', 'Deploy projects with clear evaluation criteria'],
...
export const programs: Program[] = [
  {
    ...
    learningExperience: [
      ...
      'Career OS is available when you sign in (not gated on completion)',
    ],
    faqs: [
      ...
      { q: 'Is Career OS included?', a: 'Career OS is available to signed-in accounts. It is not gated on programme completion. The job board lists only roles that exist in the product — it may be empty. There is no placement service.' },
      { q: 'What is in the live LMS today?', a: 'Enrolment currently opens Data Analytics and Python for Data Science. The 18-module machine learning and deep learning brochure path is not fully built in the LMS yet.' },
      { q: 'What certification do I receive?', a: 'Your enrolment records completion of published assessments. A downloadable certificate with a verifiable ID is not issued in this product yet.' },
    ],
    faculty: [
    ...
    pricing: [
      { name: 'Self-paced', price: 29999, originalPrice: 59999, features: ['All recorded content', '18 modules', 'Self-paced projects', 'Completion recorded on enrolment', 'Community access'] },
      { name: 'Pro', price: 44999, originalPrice: 89999, highlight: true, features: ['Everything in Self-paced', 'Weekly live classes', '6 industry projects', 'Project submissions in the LMS', 'Career resources', 'Career OS profile workspace'] },
      { name: 'Career', price: 59999, originalPrice: 119999, features: ['Everything in Pro', 'Interview preparation', 'Interview prep in Career OS', 'Resume & portfolio build', 'Application tracker in Career OS', 'Career support requests in Career OS'] },
    ],
  },
  {
    ...
    faqs: [
      ...
      { q: 'Is Career OS included?', a: 'Career OS is available to signed-in accounts. It is not gated on programme completion. The job board lists only roles that exist in the product — it may be empty. There is no placement service.' },
      { q: 'What is in the live LMS today?', a: 'The live Data Analytics course is five modules: Foundations, Excel, SQL, Power BI, and capstone projects (Sales Analysis and HR Dashboard). Python and Generative AI units in this brochure are not in the live course yet.' },
    ],
    pricing: [
      { name: 'Self-paced', price: 19999, originalPrice: 39999, features: ['All recorded content', '14 modules', 'Self-paced projects', 'Completion recorded on enrolment', 'Community access'] },
      { name: 'Pro', price: 29999, originalPrice: 59999, highlight: true, features: ['Everything in Self-paced', 'Weekly live classes', '5 industry projects', 'Project submissions in the LMS', 'Career resources'] },
      { name: 'Career', price: 39999, originalPrice: 79999, features: ['Everything in Pro', 'Interview prep', 'Career OS interview workspace', 'Resume build', 'Career OS workspace'] },
    ],
  },
  {
    slug: 'full-stack',
    ...
    pricing: [
      { name: 'Self-paced', price: 24999, originalPrice: 49999, features: ['All recorded content', '16 modules', 'Projects', 'Completion recorded on enrolment', 'Community'] },
      ...
      { name: 'Career', price: 54999, originalPrice: 109999, features: ['Everything in Pro', 'Interview prep', 'Portfolio review', 'Career OS workspace', 'Career OS workspace'] },
    ],
  },
  {
    ...
    pricing: [
      { name: 'Self-paced', price: 14999, originalPrice: 29999, features: ['All recorded content', '10 modules', 'Projects', 'Completion recorded on enrolment'] },
      { name: 'Pro', price: 24999, originalPrice: 49999, highlight: true, features: ['Everything in Self-paced', 'Live sessions', '3 AI projects', 'Project submissions in the LMS'] },
      { name: 'Career', price: 34999, originalPrice: 69999, features: ['Everything in Pro', 'Interview prep', 'AI portfolio', 'Career OS workspace'] },
    ],
  },
  {
    slug: 'product-management',
    ...
    pricing: [
      { name: 'Self-paced', price: 17999, originalPrice: 35999, features: ['Recorded sessions', '10 modules', 'Case studies', 'Completion recorded on enrolment'] },
      ...
      { name: 'Career', price: 37999, originalPrice: 75999, features: ['Everything in Pro', 'PM interview prep', 'Portfolio build', 'Career OS workspace'] },
    ],
  },
  ...
  // ─── CERTIFICATE PROGRAMS ──────────────────────────────────────────────────
  {
    ...
    pricing: [
      { name: 'Full Access', price: 4999, originalPrice: 9999, highlight: true, features: ['All 5 modules', '2 analytics projects', 'SQL practice sets', 'Completion when LMS is published', 'Community access'] },
    ],
  },
]
