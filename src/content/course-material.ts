...
import { getCareerEvidence, getLessonMeta, type WrittenLessonMeta } from "./course-lookups"
...
export type { AssignmentBrief, WrittenLessonMeta }
export { getCareerEvidence, getLessonMeta }
