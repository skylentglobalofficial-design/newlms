        ...
        <div style={{ flex: 1, overflowY: 'auto', padding: '48px 48px 80px' }}>
          ...
          <div style={{ marginBottom: 48 }}>
            <div style={{ display: 'flex', gap: 8, marginBottom: 16, flexWrap: 'wrap' }}>
              ...
              <span style={{ background: 'rgba(255,255,255,0.04)', color: C.slate, fontSize: 11, fontFamily: 'var(--font-mono)', padding: '4px 12px', borderRadius: 100, border: '1px solid rgba(255,255,255,0.08)' }}>{subject.semester}</span>
            </div>
