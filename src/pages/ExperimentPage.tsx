        ...
        <div style={{ width: 280, flexShrink: 0, background: C.cream, borderLeft: '1px solid rgba(21,23,26,0.10)', overflowY: 'auto', display: 'flex', flexDirection: 'column' }}>
          <div style={{ padding: '20px 20px 0' }}>
            ...
            <div style={{ marginBottom: 20 }}>
              ...
              <div style={{ color: C.slate, fontSize: 11.5, lineHeight: 1.7, background: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.05)', borderRadius: 8, padding: '12px' }}>
            ...
            {currentStatus === 'completed' && (
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                <div style={{ background: 'rgba(34,197,94,0.1)', border: '1px solid rgba(34,197,94,0.25)', borderRadius: 8, padding: '14px', textAlign: 'center' }}>
                  ...
                  <div style={{ fontFamily: 'var(--font-mono)', fontSize: 22, fontWeight: 700, color: C.white }}>88<span style={{ fontSize: 13, color: C.slate }}>/100</span></div>
