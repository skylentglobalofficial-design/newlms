...
export default function LockedLessonState({
  ...
  return (
    ...
    >
      ...
      <div style={{ color: C.ink, fontSize: 18, fontWeight: 600, marginBottom: 10 }}>{lessonTitle}</div>
      <p style={{ color: C.slate, fontSize: 14, margin: 0, lineHeight: 1.6, maxWidth: 420, marginInline: "auto" }}>
        {requiredLessonTitle
